...
def plot_runs_distribution(resultados, output_dir):
    """
    ...
    plt.savefig(os.path.join(output_dir, 'runs_distribution.png'))
    plt.close()

def plot_player_stats(player_stats, output_dir):
    """
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(output_dir, 'player_stats.png'))
    plt.close()

def visualize_simulation(simulator, num_simulations=1000):
    """
    ...
    plot_runs_distribution(resultados, output_dir)
    plot_player_stats(player_stats, output_dir)
    
    print("\nGráficos guardados en el directorio 'baseball_plots':")
    print("- runs_distribution.png")
    print("- player_stats.png")
